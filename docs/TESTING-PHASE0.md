...
**Phase 2.x (life):** organism, chaos, twin-mouth, and water-column behaviour are covered by Catch2 unit tests in `evo-lab-tests` — filters `[water]`, `[chaos]`, and `[twomouth]`. Design and invariants are documented in [DESIGN-NOTES.md](DESIGN-NOTES.md) §2.5, §3.1 (water bands), §4.4.1.
